...
import com.occiandiaali.diidi.ui.composables.SmallFAB
...
fun MainContent(
    ...
    courseList: List<Course> = getCourses()
) {
...
//navController.navigate(route = CourseScreens.DetailScreen.name + "/$image")
}